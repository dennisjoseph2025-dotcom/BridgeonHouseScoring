...
const houses = [
  { 
    ...
    icon: '../../assets/gryffindor.png',  // Use public path
    adminPoints: 0,
    totalPoints: 0,
    isScoring: false
  },
  { 
    ...
    icon: '../../assets/slytherin.png',  // Use public path
    adminPoints: 0,
    totalPoints: 0,
    isScoring: false
  },
  { 
    ...
    icon: '../../assets/hufflepuff.png',  // Use public path
    adminPoints: 0,
    totalPoints: 0,
    isScoring: false
  },
  { 
    ...
    icon: '../../assets/ravenclaw.png',  // Use public path
    adminPoints: 0,
    totalPoints: 0,
    isScoring: false
  },
  { 
    ...
    color: 'media', 
    bgColor: 'bg-media', 
    icon: '../../assets/media.png',  // Use public path
    adminPoints: 0,
    totalPoints: 0,
    isScoring: false
  }
